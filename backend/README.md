...
## Project Structure
    ...
    ├── testapiautodatamod_124282  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_124282`
...
2. Clone this repo and `cd testapiautodatamod_124282`
